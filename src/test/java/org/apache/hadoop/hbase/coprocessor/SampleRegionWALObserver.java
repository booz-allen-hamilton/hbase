...
implements WALCPObserver {
  ...
  @Override
  public void postWALWrite(WALCoprocessorEnvironment env, HRegionInfo info,
      HLogKey logKey, WALEdit logEdit) throws IOException {
    postWALWriteCalled = true;
  }

  @Override
  public void preWALWrite(WALCoprocessorEnvironment env, HRegionInfo info,
      HLogKey logKey, WALEdit logEdit) throws IOException {
